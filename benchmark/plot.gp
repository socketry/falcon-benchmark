...
plot \
	...
	datafile using 1:14 with lines title "cherrypy requests" axis x1y1 ls 13, \
	datafile using 1:15 with lines title "cherrypy latency" axis x1y2 ls 14, \
	datafile using 1:($16 == 0 ? NaN : $16) with linespoints title "cherrypy errors" axis x1y1 ls 15
